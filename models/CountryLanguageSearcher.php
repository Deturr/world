...
/**
 * CountryLanguageSearcher represents the model behind the search form of `app\models\CountryLanguage`.
 */
class CountryLanguageSearcher extends CountryLanguage
{
    /**
     * {@inheritdoc}
     */
